...
//(int) Math.pow(2, 31 - 1);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 240, 490, 395));
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/proyectosimulacion/logoitc (2).jpg"))); // NOI18N
        ...
        getContentPane().add(lblRi, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 670, 100, 27));

        jLabel11.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
        jLabel11.setText("Z:");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 680, -1, -1));
        getContentPane().add(txtZ, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 670, 116, 32));
        ...
        getContentPane().add(btnCalculo, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 670, -1, -1));

        jLabel12.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
        jLabel12.setText("r:");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 720, -1, -1));

        jLabel13.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
        jLabel13.setText("LIMITE INFERIOR:");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 750, -1, -1));

        jLabel14.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
        jLabel14.setText("LIMITE SUPERIOR:");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 790, -1, -1));
        getContentPane().add(lblR, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 710, 103, 24));
        getContentPane().add(lblLI, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 740, 102, 25));
        getContentPane().add(lblLS, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 780, 96, 29));

        jLabel15.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
        jLabel15.setText("RESULTADO:");
        getContentPane().add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 740, -1, -1));
        getContentPane().add(lblResul, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 770, 204, 37));

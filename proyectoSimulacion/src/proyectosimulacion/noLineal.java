...
public class noLineal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(seed, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 120, 107, -1));
        getContentPane().add(txtA, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 120, 118, -1));
        getContentPane().add(txtC, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 160, 117, -1));
        getContentPane().add(txtN, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 160, 122, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 508, 340));
        ...
        getContentPane().add(txtM, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 160, 119, -1));
        ...
        getContentPane().add(txtB, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 120, 127, -1));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 200, -1, -1));

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/proyectosimulacion/logoitc (2).jpg"))); // NOI18N
        ...
        jLabel11.setText("Ri:");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 630, -1, -1));
        getContentPane().add(lblRi, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 620, 100, 27));

        jLabel12.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
        jLabel12.setText("Z:");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 630, -1, -1));
        getContentPane().add(txtZ, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 620, 116, 32));
        ...
        getContentPane().add(btnCalculo, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 620, -1, -1));

        jLabel13.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
        jLabel13.setText("r:");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 670, -1, -1));

        jLabel14.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
        jLabel14.setText("LIMITE INFERIOR:");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 700, -1, -1));

        jLabel15.setFont(new java.awt.Font("Arial", 3, 12)); // NOI18N
        jLabel15.setText("LIMITE SUPERIOR:");
        getContentPane().add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 740, -1, -1));
        getContentPane().add(lblR, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 670, 103, 24));
        ...
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 690, -1, -1));
